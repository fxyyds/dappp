...
import { viteArchiverPlugin } from './archiver.js';
import { viteBuildTimePlugin } from './build-time.js';
import { viteCheckTransitionPlugin } from './check-transition.js';
import { viteDayjsPlugin } from './dayjs.js';
import { viteExtraAppConfigPlugin } from './extra-app-config.js';
import { viteHtmlPlugin } from './html.js';
import { viteInjectAppLoadingPlugin } from './inject-app-loading/index.js';
import { viteMetadataPlugin } from './inject-metadata.js';
import { viteLicensePlugin } from './license.js';
import { vitePrintPlugin } from './print.js';
import { viteTailwindReferencePlugin } from './tailwind-reference.js';
import { viteVxeTableImportsPlugin } from './vxe-table.js';
